...
import UserDetailReducer from "../../../redux/UserDetailReducer";
...
const User = () => {
  ...
  // };
  const Detail = (user) => {
    dispatch(UserDetailReducer.actions.setUser(user));
  ...
  return (
    <div class="flex min-h-full items-center justify-center bg-white px-8">
      <div class="text-center flex flex-col justify-between">
        <h6 class="text-gray-700 text-xl font-bold mb-3 mr-4">User</h6>
        {/* <button
          onClick={() => handleAdd()}
