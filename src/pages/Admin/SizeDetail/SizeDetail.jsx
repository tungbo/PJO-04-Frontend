...
import { GetSizeDetail } from "../../../redux/selector";
const SizeDetail = () => {
  const sizeDetail = useSelector(GetSizeDetail);
  const navigate = useNavigate();
  const [formData, setFormData] = useState(sizeDetail);
        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-100 border-0">
          <div class="rounded-t bg-white mb-0 px-6 py-6">
            <div class="text-center flex justify-between">
              <h6 class="text-gray-700 text-xl font-bold">Size Details</h6>
            </div>
          </div>
